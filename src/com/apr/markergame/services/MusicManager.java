        ...
        Disposable
{
        ...
        GameMusic music )
    {
        ...
        // do some logging
        Gdx.app.log( MarkerGame.LOG, "Playing music: " + music.name() );
    ...
    public void stop()
    {
        if( musicBeingPlayed != null ) {
            Gdx.app.log( MarkerGame.LOG, "Stopping current music" );
    ...
    public void setVolume(
        float volume )
    {
        Gdx.app.log( MarkerGame.LOG, "Adjusting music volume to: " + volume );
    ...
    public void dispose()
    {
        Gdx.app.log( MarkerGame.LOG, "Disposing music manager" );
        stop();
    }
}